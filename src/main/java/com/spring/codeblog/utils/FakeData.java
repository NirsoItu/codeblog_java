...
public class FakeData {
    ...
    // Anotação para gerar registro automático
    //@PostConstruct
    public void savePosts() {
        ...
        Post post1 = new Post();
        post1.setAutor("Rogério F. da Silva");
        ...
        for(Post post: postList) {
            ...
            System.out.println("ID: "+postSaved.getId());
        }
